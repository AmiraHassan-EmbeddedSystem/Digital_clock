        ...
        for(minutes = 0; minutes<60; minutes++){
            for(seconds = 0; seconds<60; seconds++){
                for (counter = 0; counter < 25; counter++) {
                    ...
                    gpio_port_write_logic(GPIO_PORTC, (uint8)(hours / 10));
                    }
                    _delay((unsigned long)((750)*(80000000UL/4000000.0)));
                    ...
                    gpio_port_write_logic(GPIO_PORTC, (uint8)(minutes / 10));
                    ...
                    if( ((uint8)seconds / 10) == 0 ){
                        ...
                        gpio_port_write_logic(GPIO_PORTC, (uint8)(seconds / 10));
                    }
                    _delay((unsigned long)((750)*(80000000UL/4000000.0)));
...
void initialization(void) {
    ...
    gpio_port_direction_initialize(GPIO_PORTD, 0x00);
